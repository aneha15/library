...
function displaybooks(title, author, pages, status) {
    ...
    display.style.cssText = "display: flex; flex-direction: column; gap: 10px; padding: 30px; justify-content: space-between; align-items: center;";
    bkstatus.style.cssText = 'padding: 10px; width: 120px; background-color: pink; border:none; font-size: 16px; border-radius: 5px;';
    removeButton.style.cssText = "padding: 10px; width: 120px; background-color: palegreen; font-size: 16px; border: none; border-radius: 5px;";
...
displaybooks('Before The Coffee Gets Cold', 'Toshikazu Kawaguchi', '272', 'Read');
displaybooks('Tomorrow, and Tomorrow, and Tomorrow', 'Gabrielle Zevin', '416', 'Read');
